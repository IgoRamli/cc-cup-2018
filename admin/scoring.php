...
<!-- Standart META -->
<meta content="Invitasi Olahraga SMA Kolese Kanisius 2017" name="description"/>
<meta content="osis,2017,kolese,kanisius,menteng,raya,64,lomba,college,canisius,lomba,invitasi" name="keywords"/>

<!--Facebook Tags-->
<meta content="Invitasi Olahraga SMA CC 2017" property="og:title"/>
						...
						<?php
							...
							"; } else { while($data=mysqli_fetch_array($nampung)) {
								...
								<tr>
									...
									<td>$tempat</td>
									<td>$hasil</td>
									<td><a href='edit_score.php?id=$id'>Edit</td>
